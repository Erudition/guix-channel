          ...
          (add-after 'unpack 'unpack-submodules
            (lambda* (#:key inputs #:allow-other-keys)
              ...
              (copy-recursively (assoc-ref inputs "uw-mpv-player-src")
                                "use/UW_MPVPlayer")
              (delete-file "use/UW_MPVPlayer/libMPV.Client.pas")
              (copy-file "TeroSubtitler/src/libMPV.Client.pas" "use/UW_MPVPlayer/libMPV.Client.pas")
              (delete-file "use/UW_MPVPlayer/MPVPlayer.pas")
              (copy-file "TeroSubtitler/src/MPVPlayer.pas" "use/UW_MPVPlayer/MPVPlayer.pas")
              (delete-file "use/UW_MPVPlayer/MPVPlayer.RenderGL.pas")
              (copy-file "TeroSubtitler/src/MPVPlayer.RenderGL.pas" "use/UW_MPVPlayer/MPVPlayer.RenderGL.pas")))
